...
<div className="surface-0 p-4 shadow-2 border-round">
    ...
    return (
        <>
            ...
            <BlockViewer header="Statistics" code={block7} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="grid">
                    <div className="col-12 md:col-6 lg:col-3">
                        <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
                            <div className="flex justify-content-between mb-3">
            ...
            <BlockViewer header="Form" code={block8} containerClassName="surface-0 px-4 py-8 md:px-6 lg:px-8" free>
                <div className="flex align-items-center justify-content-center">
                    <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
                        <div className="text-center mb-5">
                            <img src="/demo/images/blocks/logos/hyper.svg" alt="hyper" height={50} className="mb-3" />
